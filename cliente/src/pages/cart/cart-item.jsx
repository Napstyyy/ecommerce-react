...
export const CartItem = (props) => {
    const { id, productName, price, img1 } = props.data; //con los props recibimos los datos extraidos de los productos y los almacenamos en las variables
    ...
    return  (
        <div className="cartItem">
            ...
            <div className="description">
                <p> 
                    <b> {productName} </b>{/*se muestra el nombre del producto */}
                </p>
                <p> ${price} </p> {/*se muestra el precio del producto */}
